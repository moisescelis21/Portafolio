	...
	switch (e.target.name) {
       ...
       case "cargo":
        ...
        case "tipocuenta":
            ...
            break;
        case "cestaT":
            validarCampo(expresiones.numeros, e.target, 'cestaT');
            break;
...
formulario.addEventListener('submit', (e) => {
	...
	if (campos.cedula && campos.nombres && campos.apellidos && campos.cargo && campos.nomina && campos.centpago && campos.adscrito && campos.sueldo && campos.resolucion && campos.fechresolucion && campos.antiguedad && campos.profesion && campos.hijos && campos.nrocuenta && campos.tipocuenta && campos.cestaT) {
