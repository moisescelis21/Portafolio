...
?>
        ...
        <header class="header">
            ...
            <?php
        if ($preguntas_anuladas == '3') {
        ?>
        <form action="jugar9.php" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
       <?php } ?>
       <?php
        if ($preguntas_anuladas >= '4') {
        ?>
        <form action="jugar13.php" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
       <?php } ?>
