                ...
                <?php 
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php echo "<button  class='buttontable pdf' role='button'><a target='_blank' href='constancia2.php?id=$id' class=''><i class='bx bxs-file-pdf'></i></button>"; ?>
                        </td>
                    ...
                    <script type="text/javascript">
                                ...
                                if (opcion) {
                                    <?php echo "window.location= 'trabajadoresdelete.php?id=$id'"; ?>
                                }
                                }
                            </script>
                    </tr>
