...
<body>
    ...
    <section class="home">
        ...
        <header class="header">
            ...
            <form action="resultados2.php" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
			<!-- Grupo: Usuario -->
                <div class="container-inputs" id="grupo__porcentaje">
                    <label class="formulario__label" for="porcentaje">Elija la Ronda</label>
