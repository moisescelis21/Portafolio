...
?>
        ...
        <header class="header">
            ...
            <?php
        if ($preguntas_anuladas == '5') {
        ?>
        <form action="jugar9.php" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
       <?php } ?>
       <?php
        if ($preguntas_anuladas >= '6') {
        ?>
        <form action="jugar14.php" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
       <?php } ?>
