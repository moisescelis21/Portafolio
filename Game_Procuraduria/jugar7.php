...
<?php
$conexion=mysqli_connect('localhost','root','','procuraduria');
                        $sql5="SELECT * FROM participantes WHERE equipo = '$equipo'";
                        $result5=mysqli_query($conexion,$sql5);

                        $cantidad = 0;
                        while($mostrar5=mysqli_fetch_array($result5)){
                            $id = $mostrar5['id'];
                            $equipo = $mostrar5['equipo'];
                            $cantidad = $mostrar5['cantidad'];
...
?>
        ...
        if ($cantidad == "7") {
        ?>
         <form action="jugar8.php" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
            <!-- Grupo: Usuario -->
        ...
        <?php } ?>
            ...
            <div class="formulario__grupo formulario__grupo-btn-enviar">
                <button type="submit" name="login" id="login" type="button" value="Registrar" class="formulario__btn">Siguiente Pregunta</button>
