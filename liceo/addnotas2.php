...
if ($lapso == "Primer Lapso") {

 if ($año == '1' OR $año == '2' OR $año == '3') {
 	$contador = 0;
 	while ($contador < 9) {
 	$sql="INSERT INTO notas VALUES('id','$materia[$contador]','$nota[$contador]',0,0,'$cedula','$año')";
 ...
 if ($año == '1' OR $año == '2' OR $año == '3') {
 	...
 	$contador = $contador + 1;
 	if(!$ejecutar){
 		echo "La nota no ha sido registrado correctamente.";
 	}else{
  		echo "<script>alert('La nota ha sido registrado correctamente.'); window.location= 'estudiantes.php';</script>";
 	}
 }
}
 if ($año == '4' OR $año == '5') {
