...
<form action="secciones3.php" method="POST">
	<center><h2>Registro de Secciones</h2></center>
	<div class="head">
<input type="text" placeholder="Letra de la Seccion" name="letra_seccion" id="letra_seccion" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))'>
