...
<form action="modificare.php?id=<?php echo $id ?>" method="POST">
...
<?php 
		$conexion=mysqli_connect('localhost','root','','liceo');
		$sql="SELECT * FROM secciones WHERE año = '$anio' AND turno = '$turno'";
		$result=mysqli_query($conexion,$sql);
...
<input type="text" placeholder="Año en Curso" value="<?php echo $aniocurso;?>" name="aniocurso" id="aniocurso">
...
<button type="submit" class="boton" id="registron">Modificar</button>
</form>
</div>
</div>
<?php
