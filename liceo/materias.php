...
<form action="rmaterias.php" method="POST">
	<center><h2>Registro de Materias</h2></center>
	<div class="head">
<input type="text" placeholder="Nombre de Materia" name="materia" id="materia" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))'>
