...
<form action="restudiantes.php" method="POST">
	<center><h2>Registro de Estudiantes</h2></center>
	<div class="head">
<input type="text" placeholder="Nombres" name="nombres" id="nombres" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))'>
<input type="text" placeholder="Apellidos" name="apellidos" id="apellidos" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))'>
<input type="text" placeholder="Cedula" name="cedula" id="cedula" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57))">
<input type="text" id="edad" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57))" placeholder="Edad"  name="edad">
