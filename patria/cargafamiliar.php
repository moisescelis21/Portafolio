...
<?php 
	...
	$direccionje = $_GET['direccionje'];
	$carga = $_GET['carga'];
?>

<div class="head">
<form action="cargafamiliar2.php?cedulaje=<?php echo $cedulaje?>&carga=<?php echo $carga?>" method="POST">
	<div class="texto">
<center><h3>Registro de Carga Familiar</h3></center>
</div>
<div class="content">
...
<input type="text" placeholder="Direccion de la Casa" id="direccion" value="<?php echo $direccionje;?>" name="direccion">
</div>
<button class="boton" id="entrarSistema" type="submit">Entrar</button>
</div>
</div>
</form>
