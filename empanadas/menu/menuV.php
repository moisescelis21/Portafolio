...
<?php if ($privilegio==1) {
?>
<a href="/empanadas/menu/menuR.php">Agregar</a>
<?php }else{}?>
<table>
	<thead>
	</tr>
...
<tr>
	...
	<?php if ($privilegio == 1) {
	?>
	<td><?php echo"<a href='menuMP1.php?id=$id'>Modificar Precio</a>";?></td>
	<td><?php echo"<a href='menuA1.php?id=$id'>Agregar Cantidad</a>";?></td>
    <td><?php echo"<a href='menuQ1.php?id=$id'>Quitar Cantidad</a>";?></td>
    <td><?php echo"<a href='menuM1.php?id=$id'>Modificar</a>";?></td>
    <?php }else{} ?>
</tr>
</div>	
<?php
