...
<?php 
        ...
        while($mostrar=mysqli_fetch_array($result)){
            $id = $mostrar['id'];
            $empanada = $mostrar['empanada'];
            $precio = $mostrar['precio'];
            $cantidad = $mostrar['cantidad'];

            
?>
<form action="menuM2.php?id=<?php echo $id ?>" method="POST">
	<center><h2>Modificar Ingredientes</h2></center>
	<div class="head">
<input type="text" name="empanada" id="empanada" value="<?php echo $empanada;?>" placeholder="Ingrese el tipo de empanada">
<input type="text" name="precio" id="precio" value="<?php echo $precio;?>" placeholder="Ingrese el precio" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57))">
<input type="text" name="cantidad" id="cantidad" value="<?php echo $cantidad;?>" placeholder="Ingrese la cantidad" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57))">
<?php
}
?>
