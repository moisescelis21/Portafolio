...
<form action="menuR2.php" method="POST">
	<center><h2>Registro de Empanadas</h2></center>
	<div class="head">
<input type="text" name="empanada" id="empanada" placeholder="Ingrese el tipo de empanada">
