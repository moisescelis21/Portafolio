...
?>
<form action="bebidasM2.php?id=<?php echo $id ?>" method="POST">
	<center><h2>Modificar Bebidas</h2></center>
	<div class="head">
<input type="text" name="bebida" id="bebida" value="<?php echo $bebida;?>" placeholder="Ingrese el tipo de bebida">
<input type="text" name="precio" id="precio" value="<?php echo $precio;?>" placeholder="Ingrese el precio">
