...
<form action="bebidasR2.php" method="POST">
	<center><h2>Registro de Bebidas</h2></center>
	<div class="head">
<input type="text" name="bebida" id="bebida" placeholder="Ingrese el tipo de bebida">
