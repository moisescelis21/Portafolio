...
<form action="ubicacionesR2.php" method="POST">
	<center><h2>Registro de Direccion de Delivery</h2></center>
	<div class="head">
<input type="text" name="ubicacion" id="ubicacion" placeholder="Ingrese la ubicacion">
