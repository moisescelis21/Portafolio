...
?>
<form action="ubicacionesM2.php?id=<?php echo $id ?>" method="POST">
	<center><h2>Modificar Ubicaciones</h2></center>
	<div class="head">
<input type="text" name="ubicacion" id="ubicacion" value="<?php echo $ubicacion;?>" placeholder="Ingrese el ingrediente">
<?php
}
?>
