...
<?php 
        ...
        while($mostrar=mysqli_fetch_array($result)){
            $id = $mostrar['id'];
            $ingredientes = $mostrar['ingredientes'];
            $cantidad = $mostrar['cantidad'];

            
?>
<form action="ingredientesM2.php?id=<?php echo $id ?>" method="POST">
	<center><h2>Modificar Ingredientes</h2></center>
	<div class="head">
<input type="text" name="ingredientes" id="ingredientes" value="<?php echo $ingredientes;?>" placeholder="Ingrese el ingrediente">
