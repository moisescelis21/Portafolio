...
<form action="ingredientesR2.php" method="POST">
	<center><h2>Registro de Ingredientes</h2></center>
	<div class="head">
<input type="text" name="ingredientes" id="ingredientes" placeholder="Ingrese el ingrediente">
