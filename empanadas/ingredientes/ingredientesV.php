...
<?php }?>
<a href="/empanadas/ingredientes/ingredientesR.php">Agregar</a>
<table>
	<thead>
	</tr>
		<td>Ingredientes</td>
...
<tr>
	...
	<?php if ($privilegio == 1) {
	?>
	<td><?php echo"<a href='ingredientesA1.php?id=$id'>Agregar Cantidad</a>";?></td>
    <td><?php echo"<a href='ingredientesQ1.php?id=$id'>Quitar Cantidad</a>";?></td>
    <td><?php echo"<a href='ingredientesM1.php?id=$id'>Modificar</a>";?></td>
    <?php }else{} ?>
</tr>
</div>	
<?php
