...
<?php 
    ...
    while($mostrar=mysqli_fetch_array($result)){
     ...
     ?>
<div class="head">
<form method="POST" action="cantidad4.php?id=<?php echo $id ?>">
...
<input type="text" name="cantidad" placeholder="Cantidad" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57))" autocomplete="off">
