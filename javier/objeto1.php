...
<div class="head">
<form method="POST" action="objeto2.php">
<h1>Registro de Objetos</h1>
<div class="objetos">
<input type="text" name="objeto" id="objeto" placeholder="Nombre del Objeto" autocomplete="off">
<input type="text" name="codificacion" placeholder="Codificacion del Objeto" autocomplete="off">
