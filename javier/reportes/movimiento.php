...
<div class="head">
<form method="GET" action="movimiento2.php">
<h2>Reporte de Movimientos</h2>
<div class="objetos">
<label for="fechaI">Fecha inicial</label>
<br>
<input type="date" name="fechaI" id="fechaI" placeholder="Fecha Inicial" autocomplete="off">
<br>
<label for="fechaF">Fecha Final</label>
<br>
<input type="date" name="fechaF" id="fechaF" placeholder="Fecha Final" autocomplete="off">
