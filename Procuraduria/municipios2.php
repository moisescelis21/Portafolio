...
<body>
    ...
    <section class="home">
        ...
        <div class="container animated wow fadeIn">
            ...
            <!-- METE ITEMS AQUI -->
          <div class="contenido">
            <form action="municipios3.php" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
            <!-- Grupo: Usuario -->

            <div class="formulario__grupo" id="grupo__municipio">
                <label for="municipio" class="formulario__label">Municipio</label>
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="municipio" id="municipio" class="municipio" placeholder="Municipio...">
            ...
            <div class="formulario__grupo" id="grupo__estado">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="estado" id="estado" class="estado" placeholder="Estados...">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
