...
<html>
<head>
	<title>NOMINA COMPENSACION</title>
<meta charset="UTF-8">
...
<body>
  ...
  <center><h1 style="color: red;">COMPENSACION DE <?php echo $mes3 ?>  </h1></center>
  <?php }else{ ?>
  <center><h1 style="color: red;">COMPENSACION DE <?php echo $mes3 ?>  </h1></center>
  <?php } ?>
  <?php } ?>
...
$sql9="SELECT * FROM montos WHERE cedula='$cedula2'";
    ...
    while($mostrar9=mysqli_fetch_array($result9)){
      ...
      $compensacion = $mostrar9['compensacion'];
      $compensaciontotal = $compensaciontotal + $compensacion;
     ?>
<?php
     ...
     ?>
                    ...
                    <tr>
                        ...
                        <td style=""align="right"><?php echo number_format($compensacion,2) ?></td>
                  ...
                  ?>
                    <tr>
                        ...
                        <td style="border: none"></td>
                        <td style=""align="right"><?php echo number_format($compensaciontotal,2); ?></td>
