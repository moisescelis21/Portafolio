...
<body>
    ...
    <section class="home">
        ...
        <div class="container animated wow fadeIn">
          ...
          <div class="contenido">
            <?php $id = $_GET['id']; ?>
            <form action="bienesgedit2.php?id=<?php echo $id ?>" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
			<!-- Grupo: Usuario -->
      <?php 
                        $conexion=mysqli_connect('localhost','root','','procuraduria');
            ...
            <div class="formulario__grupo" id="grupo__grupo">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="grupo" id="grupo" class="grupo" placeholder="Grupo..." value="<?php echo $mostrar2['grupo'] ?>">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="sgrupo" id="sgrupo" class="sgrupo" placeholder="Sub-Grupo..." value="<?php echo $mostrar2['sgrupo'] ?>">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="año" id="año" class="año" placeholder="Año..." value="<?php echo $mostrar2['año'] ?>">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="numero" id="numero" class="numero" placeholder="Numero..." value="<?php echo $mostrar2['numero'] ?>">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="cantidad" id="cantidad" class="cantidad" placeholder="Cantidad..." value="<?php echo $mostrar2['cantidad'] ?>">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="descripcion" id="descripcion" class="descripcion" placeholder="Descripcion..." value="<?php echo $mostrar2['descripcion'] ?>">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
        ...
        <div class="formulario__grupo-input">
          <select class="formulario__input" name="ubicacion" id="ubicacion" class="ubicacion">
            <?php 
                        ...
                        ?>
                        <?php if ($id4 == $ubicacion) {
                        ?>
                        <option value="<?php echo $id4 ?>" selected=""><?php echo $nombre ?></option>

                        <?php
                        }else{ 
                        ?>
                        <option value="<?php echo $id4 ?>"><?php echo $nombre ?></option>
                      <?php
                    }}
                      ?>
          </select>
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="precio" id="precio" class="precio" placeholder="Valor Unitario..." value="<?php echo $mostrar2['precio'] ?>">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="observacion" id="observacion" class="observacion" placeholder="Observacion..." value="<?php echo $mostrar2['observacion'] ?>">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
