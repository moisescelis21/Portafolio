...
if (!isset($_SESSION["cedula"])) {
 ...
 mysqli_select_db($con,$db)or die("problemas al conectar con la base de datos");
  $api_key = "f46856f16e4ef370a996c35d";
 ...
 $precioactual=$precio_dolar;


 $sql="INSERT INTO preciobcv VALUES('id','$precioactual','0')";
 $ejecutar=mysqli_query($con,"SET CHARACTER SET 'utf8'");
 $ejecutar=mysqli_query($con,$sql);
 	if(!$ejecutar){
 		echo"Su Precio no ha sido registrado correctamente.";
 	}else{
    echo "<body><script>Swal.fire({
  title: 'Felicidades',
  text: 'Su Precio ha sido registrado correctamente.',
  icon: 'success',
  confirmButtonColor: '#3085d6',
  cancelButtonColor: '#d33',
  confirmButtonText: 'Entiendo'
