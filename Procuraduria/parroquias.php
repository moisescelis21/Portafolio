...
<body>
    ...
    <section class="home">
        ...
        <a href="municipios.php" class="button_back"><i class='bx bx-undo'></i>Regresar</a>
            ...
            <div class="data_table">
               <table id="myTable" class="display nowrap" style="width: 100%;">
                                                ...
                                                <div class="tools">
                                                    <ul>
                                                        <li>
                                                            ...
                                                            <a data-tooltip="Agregar Nuevo" href="parroquias2.php?id=<?php echo $id14 ?>" style="text-decoration: none;"><button  class="buttontable" role="button"><i class='bx bxs-plus-square' style="font-size: 20px;"></i></button></a>
                                                            <?php } ?>
                ...
                <?php 
                        $municipio = "";
                        $conexion=mysqli_connect('localhost','root','','procuraduria');
                        $sql2="SELECT * FROM municipios WHERE id=$id14";
                        ...
                        $conexion=mysqli_connect('localhost','root','','procuraduria');
                        $sql="SELECT * FROM parroquias WHERE municipio='$municipio'";
                        $result=mysqli_query($conexion,$sql);
                    ...
                    <tr>
                        ...
                        <td>
                             <?php if ($privilegio == "0" OR $privilegio == "0") {
                            ?>
                            <?php echo "<button  class='buttontable edit' role='button'><a href='archivosbienes.php?id=$id&id2=$id14' class=''><i class='bx bxs-show'></i></button>"; ?>
                            <?php echo "<button  class='buttontable edit' role='button'><a href='parroquiasedit.php?id=$id&id2=$id14' class=''><i class='bx bx-edit-alt'></i></button>"; ?>
                            <?php echo "<button  class='buttontable delete' role='button'><a href='parroquiasdelete.php?id=$id&id2=$id14' class=''><i class='bx bx-trash'></i></button>"; ?>
