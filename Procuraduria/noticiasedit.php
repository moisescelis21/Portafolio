        ...
        <div class="container animated wow fadeIn">
          ...
          <div class="contenido">
            <?php
                $id=$_GET['id']; 
                 ?>
            <form action="noticiasedit2.php?id=<?php echo $id ?>" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
                <?php 
                        ...
                        while($mostrar2=mysqli_fetch_array($result2)){
                            ...
                            $redaccion = $mostrar2['redaccion'];
                            $resumen = $mostrar2['resumen'];
                            $cedula = $mostrar2['cedula'];
                            $fecha = $mostrar2['fecha'];
            ...
            <div class="formulario__grupo" id="grupo__titulo">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="titulo" id="titulo" class="titulo" placeholder="Titulo" value="<?php echo $titulo ?>">
			...
			<div class="formulario__grupo" id="grupo__imagen">
				...
				<div class="formulario__grupo-input">
					<input type="file" class="formulario__input" name="imagen" id="imagen" class="imagen" placeholder="Imagen" value="<?php echo $ubicacion ?>">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
            ...
            <div class="formulario__grupo" id="grupo__redaccion">
				...
				<div class="formulario__grupo-input">
                    <input type="text" id="redaccion" name="redaccion" placeholder="Redaccion" class="formulario__input textarea redaccion" value="<?php echo $redaccion ?>">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
            ...
            <div class="formulario__grupo" id="grupo__resumen">
				...
				<div class="formulario__grupo-input">
                <input type="text" id="resumen" name="resumen" placeholder="Resumen" class="formulario__input textarea resumen" value="<?php echo $resumen ?>">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
