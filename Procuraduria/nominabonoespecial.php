...
<body>
  ...
  <center><h1 style="color: red;">BONO ESPECIAL DE <?php echo $mes3 ?>  </h1></center>
  <?php }else{ ?>
  <center><h1 style="color: red;">BONO ESPECIAL DE <?php echo $mes3 ?>  </h1></center>
  <?php } ?>
  <?php } ?>
...
$sql9="SELECT * FROM montos WHERE cedula='$cedula2'";
    ...
    while($mostrar9=mysqli_fetch_array($result9)){
      ...
      $bonoespecial = $mostrar9['especiales'];
      $bonoespecialtotal = $bonoespecialtotal + $bonoespecial;
     ?>
<?php
     ...
     ?>
                    ...
                    <tr>
                        ...
                        <td style="" align="right"><?php echo number_format($bonoespecial,2) ?></td>
                  ...
                  ?>
                    <tr>
                        ...
                        <td style="border: none"></td>
                        <td style="" align="right"><?php echo number_format($bonoespecialtotal,2); ?></td>
