          ...
          <div class="contenido">
            <?php
                ...
                $correlativo = $_GET['correlativo']; 
                 ?>
            <form action="diasedit2.php?cedula=<?php echo $cedula2 ?>&correlativo=<?php echo $correlativo ?>" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
                <?php 
                     
                    $sql2="SELECT * FROM nominapersonal WHERE cedula='$cedula2' AND correlativo='$correlativo'";
			...
			<div class="formulario__grupo" id="grupo__usuario">
				<label for="titulo" class="formulario__label">Dias trabajados</label>
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="diastrabajados" id="diastrabajados" placeholder="Dias trabajados" value="<?php echo $diastrabajados ?>">
