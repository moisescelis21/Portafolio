               ...
               <table id="myTable" class="display nowrap" style="width: 100%;">
                                            ...
                                            <div class="datatable-header" style="margin-top: -3%;">
                                                <div class="tools">
                                                    <ul>
                                                        <li>
                                                            <a data-tooltip="Agregar Nuevo" href="noticiasadd.php" style="text-decoration: none;"><button  class="buttontable" role="button"><i class='bx bxs-plus-square' style="font-size: 20px;"></i></button></a>
                ...
                <?php 
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            ?>
                            <?php echo "<button  class='buttontable edit' role='button'><a target='_blank' href='noticiasedit.php?id=$id' class=''><i class='bx bx-edit-alt'></i></button>"; ?>
                            <?php echo "<button  class='buttontable delete' role='button'><a href='noticiasdelete.php?id=$id' class=''><i class='bx bx-trash'></i></button>"; ?>
                            <?php echo "<button  class='buttontable pdf' role='button'><a target='_blank' href='noticia.php?id=$id' class=''><i class='bx bxs-file-pdf'></i></button>"; ?>
