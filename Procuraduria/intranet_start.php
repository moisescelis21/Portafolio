...
<body>
    ...
    <section class="home">
        ...
        <?php } ?>  
            ...
            <header class="header-tab animated wow fadeInUp">
                <h2>¡Bienvenido a ProcuNet!</h2>
                <p>Explora las múltiples funciones de la Intranet</p>
            </header>
        </div>
                <lottie-player class="animated wow fadeInUp" src="img/welcome.json"  background="transparent"  speed="1"  style="width: 600px; height: 600px; margin: -5% auto;" loop autoplay></lottie-player>
