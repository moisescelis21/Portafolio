      ...
      <div class="row">
        <div class="col-sm-6 login-section-wrapper">
          <div class="brand-wrapper">
            <a href="index.php" class="btn btn-danger btn-sm animated wow fadeInUp" type="button" style="color: white; font-weight: bold; "><i style="color: antiquewhite ;" class="bi bi-arrow-left-circle-fill"></i> Regresar</i></a>
          </div>
          <div class="login-wrapper my-auto">
            ...
            <a href="paso1.php" class="forgot-password-link animated wow bounceInLeft">Olvidó su contraseña?</a>
