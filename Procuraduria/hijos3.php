...
if (!isset($_SESSION["cedula"])) {
 ...
 $sql="INSERT INTO primhijos VALUES('id','$valor')";
 $ejecutar=mysqli_query($con,"SET CHARACTER SET 'utf8'");
 $ejecutar=mysqli_query($con,$sql);
}
 	if(!$ejecutar){
 		echo"El valor de la prima de hijos no ha sido registrado correctamente.";
 	}else{
    echo "<body><script>Swal.fire({
  title: 'Felicidades',
  text: 'El valor de la prima de hijos ha sido registrado correctamente.',
  icon: 'success',
  confirmButtonColor: '#3085d6',
  cancelButtonColor: '#d33',
  confirmButtonText: 'Entiendo'
