...
<body>
    ...
    <section class="home">
        ...
        <div class="container animated wow fadeIn">
            ...
            <!-- METE ITEMS AQUI -->
          <div class="contenido">
            <form action="parroquiasedit2.php?id=<?php echo $id ?>&id2=<?php echo $id2 ?>" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
            <!-- Grupo: Usuario -->
            <?php
            $conexion=mysqli_connect('localhost','root','','procuraduria');
                        $sql="SELECT * FROM parroquias WHERE id='$id'";
                        $result=mysqli_query($conexion,$sql);
            ...
            <div class="formulario__grupo" id="grupo__parroquia">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="parroquia" id="parroquia" class="parroquia" placeholder="Parroquia..." value="<?php echo $parroquia ?>">
