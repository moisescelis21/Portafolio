...
?>
    ...
    <table style="width: 100%;" border="1">
                    <tr>
                      ...
                      <th colspan="2">NOMINA EMPLEADOS</th>
                      <th colspan="10">RETENCIONES AL PERSONAL EMPLEADOS</th>
                      <th colspan="4">ASIGNACIONES AL PERSONAL EMPLEADOS</th>
    ...
    $sql="SELECT * FROM trabajadores WHERE cedula='$cedula2' AND nomina ='Empleado'";
