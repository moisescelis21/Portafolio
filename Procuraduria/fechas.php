...
<body>
    ...
    <section class="home">
        ...
        <?php } ?>  
        <a href="hijos.php" class="button_back"><i class='bx bx-undo'></i>Regresar</a>
        <div class="container animated wow fadeIn">
            <div class="top"> 
              <h1>Fecha de Vacaciones</h1>
            </div>
            <div class="space">
          ...
          <div class="contenido">
            ...
            $correlativo = $_GET['correlativo'];
             ?>
            <form action="fechas2.php?correlativo=<?php echo $correlativo?>" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
            <!-- Grupo: Usuario -->

            <div class="container-inputs" id="grupo__inicio">
                    <label class="formulario__label" for="inicio">Inicio de Vacaciones</label>
                    <div class="form__inputs">
                        <input type="date" name="inicio" id="inicio" class="inicio"
                          >
                        <i class="icon-close-outline form__validacion-estado"></i>
                    </div>
                    <p class="form__validacion-error">Introduzca la fecha de inicio.</p>
                </div>
                <div class="container-inputs" id="grupo__final">
                    <label class="formulario__label" for="final">Final de Vacaciones</label>
                    <div class="form__inputs">
                        <input type="date" name="final" id="final" class="final"
                          >
                        <i class="icon-close-outline form__validacion-estado"></i>
                    </div>
                    <p class="form__validacion-error">Introduzca la fecha de final.</p>
                </div>
