...
if (!isset($_SESSION["cedula"])) {
 ...
 if ($municipio == "") {
  echo "<body><script>Swal.fire({
  title: 'Tenemos un Problema',
  text: 'No puede dejar el campo municipio vacio.',
  icon: 'error',
  confirmButtonColor: '#3085d6',
  cancelButtonColor: '#d33',
  confirmButtonText: 'Entiendo'
  ...
  if (result.isConfirmed) {
    window.location= 'municipios.php?id=$id';
  }
})</script>";
  ...
  echo "<body><script>Swal.fire({
  title: 'Tenemos un Problema',
  text: 'No puede dejar el campo estado vacio.',
  icon: 'error',
  confirmButtonColor: '#3085d6',
  cancelButtonColor: '#d33',
  confirmButtonText: 'Entiendo'
  ...
  if (result.isConfirmed) {
    window.location= 'municipios.php?id=$id';
 	...
 	$modificacion = ("UPDATE municipios SET municipio = '$municipio', estado = '$estado' WHERE id = '$id' ");
