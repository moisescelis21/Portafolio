...
?>
<div> <?php require('./altofuncionario2.php') ?> </div>
  <br>
  <div> <?php require('./altonivel2.php') ?> </div>
<?php
}elseif ($personal == "Empleados") {
?>
<div><?php require('./empleado2.php') ?></div>
<?php
}elseif ($personal == "Obreros") {
?>
<div><?php require('./obreros2.php') ?></div>
<?php
