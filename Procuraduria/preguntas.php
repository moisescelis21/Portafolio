    ...
    <section class="home">
               ...
               <table id="myTable" class="display nowrap" style="width: 100%;">
                        ...
                        ?>
                            <li>
                                ...
                                if ($row == 0) {
                                ?>
                                <a data-tooltip="Agregar Nuevo" href="preguntadd.php" style="text-decoration: none;"><button  class="buttontable" role="button"><i class='bx bxs-plus-square' style="font-size: 20px;"></i></button></a>
                                <?php
                                }
                                ?>
        ...
        <?php 
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo "<button  class='buttontable edit' role='button'><a target='_blank' href='preguntaedit.php?id=$id' class=''><i class='bx bx-edit-alt'></i></button>"; ?>
                            <?php echo "<button  class='buttontable delete' role='button'><a href='preguntasdelete.php?id=$id' class=''><i class='bx bx-trash'></i></button>"; ?>
                        </td>
