               ...
               <table id="myTable" class="display nowrap" style="width: 100%;">
                                            ...
                                            <div class="datatable-header" style="margin-top: -3%;">
                                                <div class="tools">
                                                    <ul>
                                                        <li>
                                                            <a data-tooltip="Respaldar" href="respaldar.php" style="text-decoration: none;"><button  class="buttontable" role="button"><i class='bx bxs-plus-square' style="font-size: 20px;"></i></button></a>
                ...
                <?php 
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php echo "<button  class='buttontable pdf' role='button'><a target='_blank' href='restaurado.php?nombre=$nombre2' class=''><i class='bx bxs-file-pdf'></i></button>"; ?>
                        </td>
