               ...
               <table id="myTable" class="display nowrap" style="width: 100%;">
                ...
                <?php 
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo "<button  class='buttontable edit' role='button'><a target='_blank' href='diasedit.php?cedula=$cedula2&correlativo=$correlativo' class=''><i class='bx bx-edit-alt'></i></button>"; ?>
