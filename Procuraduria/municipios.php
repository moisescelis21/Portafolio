                                                ...
                                                <div class="tools">
                                                    <ul>
                                                        <li>
                                                            ...
                                                            if ($privilegio == "0") {
                                                            ?>
                                                            <a data-tooltip="Agregar Nuevo" href="municipios2.php" style="text-decoration: none;"><button  class="buttontable" role="button"><i class='bx bxs-plus-square' style="font-size: 20px;"></i></button></a>
                                                            <?php
                                                            }
                                                            ?>
                ...
                <?php 
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            ?>
                            <?php echo "<button  class='buttontable edit' role='button'><a href='parroquias.php?id=$id' class=''><i class='bx bxs-show'></i></button>"; ?>
                            <?php echo "<button  class='buttontable edit' role='button'><a href='municipiosedit.php?id=$id' class=''><i class='bx bx-edit-alt'></i></button>"; ?>
                            <?php echo "<button  class='buttontable delete' role='button'><a href='municipiosdelete.php?id=$id' class=''><i class='bx bx-trash'></i></button>"; ?>
