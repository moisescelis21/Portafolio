...
if ($nombre == "" OR $pertenece == "") {
  ...
  if (result.isConfirmed) {
    window.location= 'bienesubiedit.php?id=$id';
  }
})</script>";
 }else{
  $modificacion = ("UPDATE ubicaciones SET nombre = '$nombre',pertenece = '$pertenece' WHERE id = '$id' ");
