...
<body>
    ...
    <section class="home">
        ...
        <?php $id2 = $_GET['id2']; ?>
        <?php $id3 = $_GET['id3']; ?>
        <a href="archivosbienes.php?id=<?php echo $id3 ?>&id2=<?php echo $id2 ?>" class="button_back"><i class='bx bx-undo'></i>Regresar</a>
        <div class="container animated wow fadeIn">
          ...
          <div class="contenido">
            ...
            <form action="archivosbienesedit2.php?id=<?php echo $id14 ?>&id2=<?php echo $id2 ?>&id3=<?php echo $id3 ?>" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
			<!-- Grupo: Usuario -->
      <?php

                        $conexion=mysqli_connect('localhost','root','','procuraduria');
                        $sql="SELECT * FROM referencias WHERE id=$id14";
                        $result=mysqli_query($conexion,$sql);

                        while($mostrar=mysqli_fetch_array($result)){
                            $id = $mostrar['id'];
                            $COD = $mostrar['COD'];
                            $localizacion = $mostrar['localizacion'];
            ...
            <div class="formulario__grupo" id="grupo__COD">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="COD" id="COD" class="COD" placeholder="Codificacion..." value="<?php echo $COD ?>">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="localizacion" id="localizacion" class="localizacion" placeholder="Lugar Perteneciente..." value="<?php echo $localizacion ?>">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
...
modeSwitch.addEventListener("click" , () =>{
    ...
    <script src="js/validacionesFormularios/formularioarchivobienesedit.js"></script>
