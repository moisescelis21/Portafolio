...
<body>
    ...
    <section class="home">
        ...
        <?php } ?>  
        <a href="precio.php" class="button_back"><i class='bx bx-undo'></i>Regresar</a>
        <div class="container animated wow fadeIn">
          ...
          <div class="contenido">
            <?php $id = $_GET['id'];  ?>
            <form action="precioedit4.php?id=<?php echo $id ?>" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
			<!-- Grupo: Usuario -->

           <!-- DIRECCIÓN -->

                   <div class="container-inputs" id="grupo__preciomanual">
                    <label class="formulario__label" for="preciomanual">Precio de la Cestaticket</label>
                    <div class="form__inputs">
                        <input type="text" name="preciomanual" id="preciomanual" class="preciomanual"
                            placeholder="Valor(Bs.)">
                        <i class="icon-close-outline form__validacion-estado"></i>
                    </div>
                    <p class="form__validacion-error">Introduzca el valor de la Cestaticket.</p>
                </div>
...
modeSwitch.addEventListener("click" , () =>{
    ...
    <script src="js/validacionesFormularios/formulariobcvedit.js"></script>
