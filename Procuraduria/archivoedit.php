...
<body>
    ...
    <section class="home">
        ...
        <?php } ?>  
        <a href="archivos.php" class="button_back"><i class='bx bx-undo'></i>Regresar</a>
        <div class="container animated wow fadeIn">
            ...
            <!-- METE ITEMS AQUI -->
          <div class="contenido">
            <form action="archivosedit2.php?id=<?php echo $id ?>" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
			<!-- Grupo: Usuario -->
            <?php 
...
modeSwitch.addEventListener("click" , () =>{
    ...
    <script src="js/validacionesFormularios/formularioarchivosedit.js"></script>
</body>
