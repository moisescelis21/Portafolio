...
<html>
<head>
	<title>NOMINA CONTRATADOS</title>
<meta charset="UTF-8">
...
<body>
  ...
  <center><h1 style="color: red;">PAGO DE CONTRATADOS DE <?php echo $mes3 ?>  </h1></center>
  <?php }else{ ?>
  <center><h1 style="color: red;">PAGO DE CONTRATADOS DE <?php echo $mes3 ?>  </h1></center>
  <?php } ?>
  <?php } ?>
     ...
     ?>
                  ...
                  ?>
                    <tr>
                        ...
                        <td style="border: none"></td>
                        <td style=""align="right"><?php echo number_format($pagartotal,2); ?></td>
