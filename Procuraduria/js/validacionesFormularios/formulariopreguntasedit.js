...
const validarFormulario = (e) => {
	switch (e.target.name) {
		case "respuesta1":
			validarCampo(expresiones.nombre, e.target, 'respuesta1');
			break;
		case "respuesta2":
			validarCampo(expresiones.usuario, e.target, 'respuesta2');
			break;
		case "respuesta3":
			validarCampo(expresiones.numeros, e.target, 'respuesta3');
			break;
	}
}
