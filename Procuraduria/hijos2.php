...
<body>
    ...
    <section class="home">
        ...
        <div class="container animated wow fadeIn">
            ...
            <!-- METE ITEMS AQUI -->
          <div class="contenido">
            <form action="hijos3.php" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
			<!-- Grupo: Usuario -->
...
modeSwitch.addEventListener("click" , () =>{
    ...
    <!-- Javascript -->
    <script src="js/validacionesFormularios/formularioprimahijos.js"></script>
