...
<body>
    ...
    <section class="home">
        ...
        <div class="container animated wow fadeIn">
            ...
            <?php $cedula2 = $_GET['cedula']; ?>
            <?php $roles = $_GET['roles']; ?>
            <!-- METE ITEMS AQUI -->
          <div class="contenido">
            <form action="roles2.php" class="formulario" id="formulario" method="post" autocomplete="off">
			<!-- Grupo: Teléfono -->
			<div class="formulario__grupo" id="grupo__telefono" align="">
				<label for="telefono" class="formulario__label">Roles</label>
