     ...
     <table style="width: 100%;" border="1">
                <thead>
                    <tr>
                        ...
                        <th>Sueldo de 15 dias</th>
                        <th>Primas de 15 dias</th>
...
<?php
    ...
    if ($mesprueba == "8" AND $anoprueba == "2023"){
      ...
      $PH = round($salariointegral * 0.01,2);
      ...
      if ($cedula != "8874124" AND $cedula != "8878329") {
        $sueldototal4 = $sueldo;
        $sueldo15 = round($sueldo15 + $sueldo,2);
        $primas15 = round($primas15 + 0,2);
        ...
        $primas15 = round($primas15 + $asignaciones4,2);
