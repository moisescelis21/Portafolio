...
?>
            <!-- METE ITEMS AQUI -->
          <div class="contenido">
            <form action="profesionalizacionedit2.php?id=<?php echo $id ?>" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
            <!-- Grupo: Usuario -->
            <?php 
                        $conexion=mysqli_connect('localhost','root','','procuraduria');
                        $sql="SELECT * FROM primprofesion WHERE id='$id'";
                        $result=mysqli_query($conexion,$sql);
            ...
            <div class="container-inputs" id="grupo__profesion">
                    ...
                    <div class="form__inputs">
                        <input type="text" name="profesion" id="profesion" class="profesion"
                            placeholder="Profesión" value="<?php echo $profesion ?>">
            ...
            <div class="container-inputs" id="grupo__porcentaje">
                    ...
                    <div class="form__inputs">
                        <input type="text" name="porcentaje" id="porcentaje" class="porcentaje"
                            placeholder="Valor(%)" value="<?php echo $porcentaje ?>">
                        <i class="icon-close-outline form__validacion-estado"></i>
                    </div>
...
modeSwitch.addEventListener("click" , () =>{
    ...
    <!-- Javascript -->
    <script src="js/validacionesFormularios/formularioprimaprofesedit.js"></script>
