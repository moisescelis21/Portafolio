...
<body>
    ...
    <section class="home">
        ...
        <?php } ?>  
        <a href="antiguedad.php" class="button_back"><i class='bx bx-undo'></i>Regresar</a>
        <div class="container animated wow fadeIn">
            <div class="top"> 
              <h1>Prima de Antiguedad</h1>
            </div>
            <div class="space">
...
?>
            ...
            <!-- METE ITEMS AQUI -->
          <div class="contenido">
            <form action="antiguedadedit2.php?id=<?php echo $id ?>" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
            <!-- Grupo: Usuario -->
             <?php 
                        
                        $conexion=mysqli_connect('localhost','root','','procuraduria');
                        $sql="SELECT * FROM primantiguedad WHERE id='$id'";
                        $result=mysqli_query($conexion,$sql);
            ...
            <div class="container-inputs" id="grupo__tiempo">
                    <label class="formulario__label" for="tiempo">Años</label>
                    <div class="form__inputs">
                        <input type="text" name="tiempo" id="tiempo" class="tiempo"
                            placeholder="Años" value="<?php echo $tiempo ?>">
                ...
                <div class="container-inputs" id="grupo__porcentaje">
                    <label class="formulario__label" for="porcentaje">Porcentaje</label>
                    <div class="form__inputs">
                        <input type="text" name="porcentaje" id="porcentaje" class="porcentaje"
                            placeholder="Porcentaje %" value="<?php echo $porcentaje ?>">
                        <i class="icon-close-outline form__validacion-estado"></i>
                    </div>
...
modeSwitch.addEventListener("click" , () =>{
    ...
    <script src="js/validacionesFormularios/formularioprimasantiguedadedit.js"></script>
</body>
