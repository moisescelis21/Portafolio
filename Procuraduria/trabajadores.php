               ...
               <table id="myTable" class="display nowrap" style="width: 100%;">
                                            ...
                                            <div class="datatable-header" style="margin-top: -3%;">
                                                <div class="tools">
                                                    <ul>
                                                        <li>
                                                            <a data-tooltip="Agregar Nuevo" href="trabajadoresadd.php" style="text-decoration: none;"><button  class="buttontable" role="button"><i class='bx bxs-plus-square' style="font-size: 20px;"></i></button></a>
                ...
                <?php 
                    ...
                    <tr>
                        ...
                        <td><?php echo date("d/m/Y", strtotime($mostrar['fechresolucion'])) ?></td>
                        <td>
                            <?php if ($privilegio == "1" OR $privilegio == "0") {
                            ?>
                            <?php echo "<button  class='buttontable edit' role='button'><a target='_blank' href='trabajadoresedit.php?cedula=$cedula2' class=''><i class='bx bx-edit-alt'></i></button>"; ?>
                            <?php echo "<button  class='buttontable delete' role='button'><a href='trabajadoresdelete.php?id=$id' class=''><i class='bx bx-trash'></i></button>"; ?>
                            <?php echo "<button  class='buttontable pdf' role='button'><a target='_blank' href='constaguard.php?id=$id&cedula=$cedula2' class=''><i class='bx bxs-file-pdf'></i></button>"; ?>
