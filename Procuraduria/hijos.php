            ...
            <div class="data_table">
               <table id="myTable" class="display nowrap" style="width: 100%;">
                        ...
                        ?>
                                            <div class="datatable-header" style="margin-top: -3%;">
                                                <div class="tools">
                                                    <ul>
                                                        <li>
                        <a data-tooltip="Agregar Nuevo" href="hijos2.php" style="text-decoration: none;"><button  class="buttontable" role="button"><i class='bx bxs-plus-square' style="font-size: 20px;"></i></button></a>
                ...
                <?php 
                        ...
                        ?>
                    <tr>
                        <td>Bs. <?php echo $mostrar['valor']; ?></td>
                        <td>
                            <?php if ($privilegio == "1" OR $privilegio == "0") {
                            ?>
                            <?php echo "<button  class='buttontable edit' role='button'><a href='hijosedit.php?id=$id' class=''><i class='bx bx-edit-alt'></i></button>"; ?>
                            <?php echo "<button  class='buttontable delete' role='button'><a href='hijosdelete.php?id=$id' class=''><i class='bx bx-trash'></i></button>"; ?>
                        <?php }else{ ?>
                            <?php echo "<button  class='buttontable edit' role='button'><a href='hijosedit.php?id=$id' class=''><i class='bx bx-edit-alt'></i></button>"; ?>
                        <?php } ?>
                        </td>
