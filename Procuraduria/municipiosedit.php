...
<body>
    ...
    <section class="home">
        ...
        <div class="container animated wow fadeIn">
            ...
            <!-- METE ITEMS AQUI -->
          <div class="contenido">
            <form action="municipiosedit2.php?id=<?php echo $id14 ?>" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
            <!-- Grupo: Usuario -->
            <?php 
                        $conexion=mysqli_connect('localhost','root','','procuraduria');
            ...
            <div class="formulario__grupo" id="grupo__municipio">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="municipio" id="municipio" class="municipio" placeholder="Municipio..." value="<?php echo $municipio ?>">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
                    <p class="form__validacion-error">Ingrese el nombre del municipio.</p>
                </div>

            <div class="formulario__grupo" id="grupo__estado">
                <label for="estado" class="formulario__label">Estados</label>
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="estado" id="estado" class="estado" placeholder="Estados..." value="<?php echo $estado ?>">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
                    <p class="form__validacion-error">Ingrese el nombre del estado.</p>
                </div>
