    ...
    <section class="home">
        ...
        <div class="container animated wow fadeIn">
          ...
          <div class="contenido">
            ...
            <form action="bienesubi3.php" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
			<!-- Grupo: Usuario -->

            <div class="formulario__grupo" id="grupo__nombre">
				<label for="nombre" class="formulario__label">Direccion/Coordinacion o Ubicacion</label>
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="nombre" id="nombre" class="nombre" placeholder="Direccion/Coordinacion o Ubicacion...">
