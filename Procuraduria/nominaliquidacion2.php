...
<?php
  ...
  $html=file_get_contents("http://localhost/Procuraduria/nominaliquidacion.php?correlativo=$correlativo");
  ...
  $dompdf->stream("nominaliquidacion-".$correlativo.".pdf", array("Attachment" => false));
?>