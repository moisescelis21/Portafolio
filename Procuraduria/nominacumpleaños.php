...
<body>
  ...
  <center><h1 style="color: red;">CUMPLEAÑEROS <?php echo $mes3 ?>  </h1></center>
  <?php }else{ ?>
  <center><h1 style="color: red;">CUMPLEAÑEROS DE <?php echo $mes3 ?>  </h1></center>
  <?php } ?>
  <?php } ?>
...
$sql3="SELECT * FROM preciobcv";
    ...
    while($mostrar3=mysqli_fetch_array($result3)){
      ...
      $cumpleañostotal = $cumpleañostotal + $cumpleaños;
     ?>
<?php
     ...
     ?>
                    ...
                    <tr>
                        ...
                        <td style=""align="right"><?php echo number_format($cumpleaños,2) ?></td>
                  ...
                  ?>
                    <tr>
                        ...
                        <td style="border: none"></td>
                        <td style=""align="right"><?php echo number_format($cumpleañostotal,2); ?></td>
