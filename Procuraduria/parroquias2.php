...
<body>
    ...
    <section class="home">
        ...
        <?php $id14 = $_GET['id']; ?>
        <a href="parroquias.php?id=<?php echo $id14 ?>" class="button_back"><i class='bx bx-undo'></i>Regresar</a>
        <div class="container animated wow fadeIn">
            ...
            <!-- METE ITEMS AQUI -->
          <div class="contenido">
            <form action="parroquia3.php?id=<?php echo $id14 ?>" class="formulario" id="formulario" method="post" autocomplete="off" enctype="multipart/form-data">
            <!-- Grupo: Usuario -->

            <div class="formulario__grupo" id="grupo__parroquia">
                <label for="parroquia" class="formulario__label">Parroquia</label>
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="parroquia" id="parroquia" class="parroquia" placeholder="Parroquia...">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
                    <p class="form__validacion-error">Ingrese el nombre de la parroquia.</p>
                </div>
