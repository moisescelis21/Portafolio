               ...
               <table id="myTable" class="display nowrap" style="width: 100%;">
                        ...
                        ?>
                            <li>
                                ...
                                if ($row == 0) {
                                ?>
                                <a data-tooltip="Agregar Nuevo" href="preciobcv2.php" style="text-decoration: none;"><button  class="buttontable" role="button"><i class='bx bxs-plus-square' style="font-size: 20px;"></i></button></a>
                                <?php
                                }
                                ?>
                ...
                <thead>
                    <tr>
                        <th>Tasa Actual del Bcv</th>
                        <th>Tasa Manual del Bcv</th>
                        <th>Precio Actual de la Cestaticket</th>
                        <th>Precio Manual de la Cestaticket</th>
                        <th>Precio Actual del Guerra Economica</th>
                        <th>Acción</th>
                ...
                <?php 
                        ...
                        while($mostrar=mysqli_fetch_array($result)){
                            $id = $mostrar['id'];
                            $precioactual = $mostrar['precioactual'];
                            $preciomanual = $mostrar['preciomanual'];
                            $cestaticket1 = round($precioactual*40,2);
                            $cestaticket2 = round($preciomanual*40,2);
                            $guerra = round($precioactual * 30,2);

                            
                        ?>
                    <tr>
                        <td>Bs.<?php echo $mostrar['precioactual']; ?></td>
                        <td>Bs.<?php echo $mostrar['preciomanual']; ?></td>
                        <td>Bs.<?php echo $cestaticket1; ?></td>
                        <td>Bs.<?php echo $cestaticket2; ?></td>
                        <td>Bs.<?php echo $guerra; ?></td>

                        <td>
                             <?php if ($privilegio == "1" OR $privilegio == "0") {
                            ?>
                            <?php echo "<button  class='buttontable pdf' role='button'><a target='_blank' href='precioedit2.php?id=$id' class=''><i class='bx bx-refresh'></i></button>"; ?>
                            <?php echo "<button  class='buttontable edit' role='button'><a target='_blank' href='precioedit3.php?id=$id' class=''><i class='bx bx-edit-alt'></i></button>"; ?>
                            <?php echo "<button  class='buttontable delete' role='button'><a href='preciodelete.php?id=$id' class=''><i class='bx bx-trash'></i></button>"; ?>
                        <?php }else{ ?>
                            <?php echo "<button  class='buttontable pdf' role='button'><a target='_blank' href='precioedit2.php?id=$id' class=''><i class='bx bx-refresh'></i></button>"; ?>
                            <?php echo "<button  class='buttontable edit' role='button'><a target='_blank' href='precioedit3.php?id=$id' class=''><i class='bx bx-edit-alt'></i></button>"; ?>
