...
<p class="header__title">Base de Datos</p>
<div class="container__section-table">
    ...
    <div class="datatable-header">
                    <div class="tools">
                        <ul>
                            <li>
                                <a href="respaldar.php"><button><i class="ri-save-2-line"></i></button></a>
                            </li>
                        </ul>
                    </div>
                </div>
    <table id="myTable" class="table is-striped datatable" style="width: 100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <?php echo "<td><a href='restaurado.php?nombre=$nombre2' class='edit'>Restaurar</a></td>"; ?>
            </tr>
<?php } ?>
        </tbody>
    </table>
