...
<p class="header__title">Registro de Productos </p>
<div class="container__section-table">
    ...
    <div class="datatable-header">
                    <div class="tools">
                        <ul>
                            <li>
                                <a href="productos2.php"><button><i class="ri-add-box-line"></i></button></a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <table id="myTable" class="table is-striped datatable" style="width: 100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <?php echo "<td><a href='productosedit.php?id=$id' class='edit'><i class='ri-edit-box-line'></i> Editar</a></td>";?>
                <?php echo "<td><a href='productosdelete.php?id=$id' class='drop'><i class='ri-delete-back-2-line'></i> Eliminar</a></td>";?>
            </tr>
<?php } ?>
        </tbody>
    </table>
