...
<div class="container__section-avatar">
    ...
    <form class="form" id="formulario" action="shop-system-profile2.php?id_usuario=<?php echo $id ?>" method="POST" autocomplete="off">
        ...
        <div class="form_container">
            ...
            <div class="container-inputs" id="grupo__usuario">
                ...
                <div class="form__inputs">
                    <input type="text" name="usuario" id="usuario" class="usuario" value="<?php echo $usuario ?>" disabled>
                </div>
            </div>
            ...
            <div class="container-inputs" id="grupo__correo">
                ...
                <div class="form__inputs">
                    <input type="email" name="correo" id="correo" class="correo" value="<?php echo $correo ?>" disabled>
                </div>
            </div>
            ...
            <div class="container-inputs" id="grupo__cedula">
                ...
                <div class="form__inputs">
                    <input type="cedula" name="cedula" id="cedula" class="cedula" value="<?php echo $cedula ?>" disabled>
