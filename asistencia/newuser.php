...
<form action="newuser2.php" method="POST">
    ...
    <div class="head">
        <input type="text" placeholder="Nombre" name="nombre" id="nombre" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))'>
<input type="text" placeholder="Apellidos" name="apellido" id="apellido" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))'>
<input type="text" placeholder="Usuario" name="usuario" id="usuario">
<input type="password" id="contraseña"  placeholder="Password"  name="password">
<input type="text" id="cedula"  placeholder="Cedula"  name="cedula" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57))">
