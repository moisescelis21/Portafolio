...
<form action="modificarasispersonal2.php?id=<?php echo $id2 ?>" method="POST">
	<center><h2>Modificacion de Asistencia</h2></center>
	<div class="head">
	<?php 
		

		$conexion=mysqli_connect('localhost','root','','asistencia');
		$sql="SELECT * FROM asistenciapersonal WHERE id_asistencia='$id2'";
		...
		while($mostrar=mysqli_fetch_array($result)){
		 ...
		 ?>
<input type="text" placeholder="Entrada" name="entrada" id="entrada" value="<?php echo $entrada ?>" >
<input type="text" placeholder="Salida" name="salida" id="salida" value="<?php echo $salida ?>" >
