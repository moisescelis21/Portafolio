...
<form action="addnotas2.php" method="POST">
...
<input type="text" placeholder="<?php echo $materia; ?>" name="nota<?php echo $nota2 ?>" id="nota<?php echo $nota2 ?>" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57))">
