...
const validarFormulario = (e) => {
	switch (e.target.name) {
        case "direccion":
			...
			break;
		case "equipo":
			validarCampo(expresiones.usuario, e.target, 'equipo');
			break;
		case "marca":
			validarCampo(expresiones.usuario, e.target, 'marca');
			break;
		case "serial":
			validarCampo(expresiones.usuario, e.target, 'serial');
			break;
		case "serialB":
			validarCampo(expresiones.usuario, e.target, 'serialB');
			break;
		case "color":
			validarCampo(expresiones.nombre, e.target, 'color');
			break;
		case "observacion":
			validarSelect(e.target, 'observacion')
			break;
...
formulario.addEventListener('submit', (e) => {
	...
	if (campos.equipo && campos.marca && campos.serial && campos.serialB && campos.color) {
