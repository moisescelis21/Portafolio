            ...
            <div class="container__section-table">
                ...
                <div class="datatable-header">
                    <div class="tools">
                        <ul>
                            <li>
                                <a href="trabajadoresadd.php"><button><i class="icon-add-outline"></i></button></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <table id="myTable" class="table is-striped datatable" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                    <?php echo"<a href='trabajadoresedit.php?id=$id'><i class='edit bx bxs-edit'></i></a>";?>
                            ...
                            ?>
                                ...
                                if (opcion) {
                                    <?php echo "window.location= 'php/trabajadoresdelete.php?id=$id'"; ?>
                                }
                                }
                            </script>
                        </tr>
